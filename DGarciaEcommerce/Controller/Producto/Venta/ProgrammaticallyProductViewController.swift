//
//  ProgrammaticallyProductViewController.swift
//  DGarciaEcommerce
//
...
class ProgrammaticallyProductViewController: UIViewController {
...
extension ProgrammaticallyProductViewController : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//        cell.imageOutlet.image = UIImage(named: areas[indexPath.row].Nombre)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("MOstrar vista detail de \(indexPath.row)")
    }
